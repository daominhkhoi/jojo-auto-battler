...
export const CHAMPION_POOL = [
    // --- TƯỚNG 1 VÀNG ---
    {
        ...
        hp: 100000, attack: 1125, attack_range: 1, speed: 0.6, max_mana: 50,
    ...
    },
    {
        ...
        hp: 80000, attack: 1500, attack_range: 1, speed: 0.9, max_mana: 60,
    ...
    },
    {
        ...
        hp: 70000, attack: 1875, attack_range: 1, speed: 1.2, max_mana: 50,
    ...
    },
    {
        ...
        hp: 60000, attack: 1500, attack_range: 1, speed: 1.2, max_mana: 60,
    ...
    },
    {
        ...
        hp: 50000, attack: 750, attack_range: 1, speed: 0.5, max_mana: 40,
    ...
    // --- TƯỚNG 2 VÀNG ---
    {
        ...
        hp: 60000, attack: 3000, attack_range: 5, speed: 1.5, max_mana: 60,
    ...
    },
    {
        ...
        hp: 60000, attack: 2625, attack_range: 1.5, speed: 0.7, max_mana: 80,
    ...
    },
    {
        ...
        hp: 60000, attack: 2250, attack_range: 2, speed: 1.0, max_mana: 140,
    ...
    },
    {
        ...
        hp: 50000, attack: 2625, attack_range: 1.5, speed: 1.1, max_mana: 60,
    ...
    },
    {
        ...
        hp: 60000, attack: 3375, attack_range: 4, speed: 0.9, max_mana: 60,
    ...
    // --- TƯỚNG 3 VÀNG ---
    {
        ...
        hp: 80000, attack: 3375, attack_range: 1, speed: 0.8, max_mana: 140,
    ...
    },
    {
        ...
        hp: 70000, attack: 4500, attack_range: 1, speed: 2.0, max_mana: 60,
    ...
    },
    {
        ...
        hp: 80000, attack: 750, attack_range: 5, speed: 0.5, max_mana: 40,
    ...
    // --- TƯỚNG 4 VÀNG ---
    {
        ...
        hp: 70000, attack: 5250, attack_range: 1, speed: 1.3, max_mana: 80,
    ...
    },
    {
        ...
        hp: 60000, attack: 5625, attack_range: 1, speed: 1.0, max_mana: 90,
    ...
    },
    {
        ...
        hp: 70000, attack: 4875, attack_range: 4, speed: 1.8, max_mana: 100,
    ...
    },
    {
        ...
        hp: 90000, attack: 4500, attack_range: 1, speed: 1.2, max_mana: 75,
    ...
    },
    {
        ...
        hp: 80000, attack: 5250, attack_range: 2, speed: 1.3, max_mana: 80,
    ...
    },
    {
        ...
        hp: 90000, attack: 3750, attack_range: 1, speed: 0.8, max_mana: 90,
    ...
    },
    {
        ...
        hp: 100000, attack: 4125, attack_range: 1, speed: 1.0, max_mana: 80,
    ...
    },
    {
        ...
        hp: 100000, attack: 4875, attack_range: 1, speed: 1.5, max_mana: 70,
    ...
    },
    {
        ...
        hp: 100000, attack: 5250, attack_range: 3, speed: 1.0, max_mana: 80,
    ...
    },
    {
        ...
        hp: 200000, attack: 4125, attack_range: 1, speed: 0.4, max_mana: 50,
    ...
    },
    {
        ...
        hp: 80000, attack: 5625, attack_range: 1, speed: 1.2, max_mana: 70,
    ...
    // --- TƯỚNG 5 VÀNG ---
    {
        ...
        hp: 50000, attack: 6000, attack_range: 1, speed: 1.2, max_mana: 100,
    ...
    },
    {
        ...
        hp: 60000, attack: 10500, attack_range: 1, speed: 1.4, max_mana: 100,
    ...
    },
    {
        ...
        hp: 150000, attack: 9000, attack_range: 2, speed: 1.5, max_mana: 120,
    ...
    },
    {
        ...
        hp: 60000, attack: 6750, attack_range: 2, speed: 1.0, max_mana: 90,
    ...
    },
    {
        ...
        hp: 85000, attack: 11250, attack_range: 1, speed: 1.5, max_mana: 90,
    ...
    },
    {
        ...
        hp: 150000, attack: 1500, attack_range: 5, speed: 0.5, max_mana: 50,
